...
# -*- coding: utf-8 -*-
#
# awsapicli documentation build configuration file, created by
# sphinx-quickstart
#
...
sphinx.ext.apidoc.main(argv=['-f', '-o', os.path.join(project_root, 'docs'),
                             os.path.join(project_root, '''awsapicli''')])
...
version = awsapicli.__version__
# The full version, including alpha/beta/rc tags.
release = awsapicli.__version__
...
htmlhelp_basename = '''awsapiclidoc'''
